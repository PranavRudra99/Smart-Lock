...
public class sign_in_existing extends AppCompatActivity {
    private static final int RC_SIGN_IN=0;
    private GoogleSignInClient mGoogleSignInClient;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference();
    CharSequence text = "This account doesn't exist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_existing);
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        ...
        try {
            ...
            mDatabase.child("USERS").child(temp).addValueEventListener(new ValueEventListener() {
                @Override
